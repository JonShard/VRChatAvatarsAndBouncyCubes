...
public class VRC_SdkControlPanel : EditorWindow
{
    ...
    [MenuItem("Odds SDK/Upload Panel")]
    static void Init()
    {
        ...
        window.titleContent.text = "Upload";
    ...
    [MenuItem("Odds SDK/Help/Developer FAQ")]
    ...
    [MenuItem("Odds SDK/Help/VRChat Discord")]
    ...
    [MenuItem("Odds SDK/Help/Avatar Optimization Tips")]
    ...
    [MenuItem("Odds SDK/Help/Avatar Rig Requirements")]
