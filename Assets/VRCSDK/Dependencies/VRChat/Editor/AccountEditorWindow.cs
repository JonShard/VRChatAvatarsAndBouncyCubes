...
namespace VRC
{
    ...
    public class AccountEditorWindow : EditorWindow 
    {
        ...
        public static void CreateWindow()
        {
            ...
            Init();
            window = EditorWindow.GetWindow<AccountEditorWindow>("Settings");
            window.Show();
        }
        ...
        static bool OnAccountGUI()
        {
			...
			EditorGUILayout.EndVertical();
			EditorGUILayout.Separator();
			 EditorGUILayout.LabelField("Odds SDK Options", EditorStyles.boldLabel);
			 GUILayout.BeginHorizontal();
			 GUI.backgroundColor = Color.cyan;
			 if (GUILayout.Button("   Add VRC Layers     "))
                {
                    UpdateLayers.SetupEditorLayers();
                }
				if (GUILayout.Button("Import Dynamic Bones"))
                {
					AssetDatabase.ImportPackage("Assets/VRCSDK/Dependencies/VRChat/Editor/DynamicBones.unitypackage",true);
                }
				GUILayout.EndHorizontal();
				GUILayout.BeginHorizontal();
				if (GUILayout.Button("Import Cubed Shaders"))
                {
					AssetDatabase.ImportPackage("Assets/VRCSDK/Dependencies/VRChat/Editor/CubedParadox.unitypackage",true);
                }
				if (GUILayout.Button("Import Poiyomi's Master"))
                {
					AssetDatabase.ImportPackage("Assets/VRCSDK/Dependencies/VRChat/Editor/Poiyomi.unitypackage",true);
                }
